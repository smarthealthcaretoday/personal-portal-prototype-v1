package today.smarthealthcare.ppv1.dto.selfHealthCheck;
 ...
 */
public class SelfHealthCheckDto implements Serializable {
    private Long id;
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("headache", headache)
                .add("painInBones", painInBones)
                .add("painInRespiratoryTract", painInRespiratoryTract)
                .add("stomachacheTop", stomachacheTop)
                .add("stomachacheMiddle", stomachacheMiddle)
                .add("stomachacheBottom", stomachacheBottom)
                .add("rheum", rheum)
                .add("cough", cough)
                .add("painInThroat", painInThroat)
                .add("painInLungs", painInLungs)
                .add("rheumAndThroat", rheumAndThroat)
                .add("stitchesInHeartZone", stitchesInHeartZone)
                .add("stitchesInOtherBodyParts", stitchesInOtherBodyParts)
                .add("cardiacRhythmDisorders", cardiacRhythmDisorders)
                .add("fever", fever)
                .add("vomiting", vomiting)
                .add("diarrhea", diarrhea)
                .add("injury", injury)
                .add("inflammationVisible", inflammationVisible)
                .add("inflammationNotVisible", inflammationNotVisible)
                .add("urination", urination)
                .add("anxiety", anxiety)
                .add("date", date)
                .toString();
    }
